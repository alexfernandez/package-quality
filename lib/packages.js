...
exports.updatePackage = function(object, callback)
{
	openCollection(function(error, collection)
	{
		if (error)
		...
		collection.update({name: object.name}, {'$set': object}, {upsert: true}, function(error, result)
		{
			if (error)
			{
...
function testFindPackage(callback)
{
	...
	exports.updatePackage(object, function(error)
	{
